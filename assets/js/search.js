...
var documents = [{
    "id": 0,
    "url": "https://TylerLeonhardt.github.io/404.html",
    "title": "",
    "body": " 404 Page not found :(  The requested page could not be found. "
    }, {
    "id": 1,
    "url": "https://TylerLeonhardt.github.io/about/",
    "title": "About Me",
    ...
    "id": 2,
    "url": "https://TylerLeonhardt.github.io/categories/",
    "title": "Tags",
    "body": "Contents: {% if site. categories. size &gt; 0 %} {% for category in site. categories %} {% capture category_name %}{{ category | first }}{% endcapture %} {{ category_name }}{% endfor %}{% endif %} {% for category in site. categories %}  {% capture category_name %}{{ category | first }}{% endcapture %} &lt;h3 id = {{ category_name }} &gt;&lt;i class= fas fa-tags category-tags-icon &gt;&lt;/i&gt;&lt;/i&gt; {{ category_name }}&lt;/h3&gt;&lt;a name= {{ category_name | slugize }} &gt;&lt;/a&gt;{% for post in site. categories[category_name] %}{%- assign date_format = site. minima. date_format | default:  %b %-d, %Y  -%}&lt;article class= archive-item &gt; &lt;p class= post-meta post-meta-title &gt;&lt;a class= page-meta  href= {{ site. baseurl }}{{ post. url }} &gt;{{post. title}}&lt;/a&gt; • {{ post. date | date: date_format }}&lt;/p&gt;&lt;/article&gt;{% endfor %} {% endfor %}"
    }, {
    "id": 3,
    "url": "https://TylerLeonhardt.github.io/images/copied_from_nb/",
    "title": "",
    "body": "WarningDo not manually save images into this folder. This is used by GitHub Actions to automatically copy images.  Any images you save into this folder could be deleted at build time. "
    }, {
    "id": 4,
    "url": "https://TylerLeonhardt.github.io/2020/03/03/Azure-PowerShell-VM-Visualization-Demo.html",
    "title": "Title",
    "body": "2020/03/03 -           Azure PowerShell VM Visualization demo &#182;Prerequisites&#182;: You'll need to install Az. Compute for this Notebook.       Install-Module Az. Compute -Force    First connect to your Azure account.       Connect-AzAccount  WARNING: To sign in, use a web browser to open the page https://microsoft. com/devicelogin and enter the code ESEQGS95X to authenticate. Account        SubscriptionName TenantId               Environment-------        ---------------- --------               -----------tyleonha@microsoft. com Thanks Microsoft 72f988bf-86f1-41af-91ab-2d7cd011db47 AzureCloud  (Optional) If your account contains more than one active subscription the first one will be selected for further use. To select another subscription, use Set-AzContext.       Set-AzContext -Subscription &quot;My Subscription&quot;    Demo&#182;: We'll be fetching the  PowerState  of each of our VMs in Azure and plotting it on a pie chart. First, let's get the data:       $vms = Get-AzVM -Status$data = $vms. PowerState$groupedData = $data | Group-Object$groupedData  Count Name           Group----- ----           -----  4 VM deallocated      {VM deallocated, VM deallocated, VM deallocated, VM deallocated}  4 VM running        {VM running, VM running, VM running, VM running}  Now we can render that data into a Pie graph and plot it in a chart:       $trace = [Graph. Pie]@{  name = &quot;VM PowerState&quot;  labels = $groupedData. Name  values = [int[]]($groupedData | % Count)}New-PlotlyChart -Title &quot;VM Status&quot; -Trace $trace | Out-Display    "
    }, {
    "id": 5,
    "url": "https://TylerLeonhardt.github.io/fastpages/jupyter/2020/02/20/test.html",
    ...
    "id": 6,
    "url": "https://TylerLeonhardt.github.io/fastpages/markdown/2020/01/14/test-markdown-post.html",
